...
<p style="margin:0 0 20px 0;">Nous avons bien re&ccedil;u votre demande de <strong>${safeType}</strong> conform&eacute;ment &agrave; la Loi sur la protection des renseignements personnels (Loi 25).</p>
<table role="presentation" width="100%" cellpadding="0" cellspacing="0" style="margin:0 0 20px 0;border:1px solid #e4e4e7;border-radius:8px;overflow:hidden;">
  <tr><td style="padding:16px 20px;background-color:#fafafa;">
    ...
    <p style="margin:0 0 12px 0;font-size:15px;font-weight:600;color:#18181b;">${safeType}</p>
    ...
    <p style="margin:0;font-size:15px;font-weight:600;color:#18181b;">${safeDeadline}</p>
  </td></tr>
</table>
...
<p style="margin:0 0 20px 0;">We have received your <strong>${safeType}</strong> request under Quebec privacy law (Loi 25).</p>
<table role="presentation" width="100%" cellpadding="0" cellspacing="0" style="margin:0 0 20px 0;border:1px solid #e4e4e7;border-radius:8px;overflow:hidden;">
  <tr><td style="padding:16px 20px;background-color:#fafafa;">
...
<p style="margin:0 0 20px 0;">Hemos recibido su solicitud de <strong>${safeType}</strong> bajo la Ley 25 de Quebec.</p>
<table role="presentation" width="100%" cellpadding="0" cellspacing="0" style="margin:0 0 20px 0;border:1px solid #e4e4e7;border-radius:8px;overflow:hidden;">
  <tr><td style="padding:16px 20px;background-color:#fafafa;">
