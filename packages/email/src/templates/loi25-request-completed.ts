...
export function html(data: EmailData): string {
  ...
  const reasonBlock = reason ? `<p style="margin:16px 0 0 0;padding:12px 16px;background-color:#fef2f2;border-radius:8px;font-size:13px;color:#991b1b;"><strong>Motif :</strong> ${reason}</p>` : "";
  const reasonBlockEn = reason ? `<p style="margin:16px 0 0 0;padding:12px 16px;background-color:#fef2f2;border-radius:8px;font-size:13px;color:#991b1b;"><strong>Reason:</strong> ${reason}</p>` : "";
  const reasonBlockEs = reason ? `<p style="margin:16px 0 0 0;padding:12px 16px;background-color:#fef2f2;border-radius:8px;font-size:13px;color:#991b1b;"><strong>Motivo:</strong> ${reason}</p>` : "";
...
<p style="margin:0 0 12px 0;">Votre demande de <strong>${type}</strong> a &eacute;t&eacute; trait&eacute;e.</p>
...
<p style="margin:0 0 12px 0;">Your <strong>${type}</strong> request has been processed.</p>
...
<p style="margin:0 0 12px 0;">Su solicitud de <strong>${type}</strong> ha sido procesada.</p>
